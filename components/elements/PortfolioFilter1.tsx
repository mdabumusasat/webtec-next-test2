...
const products: Product[] = [
	...
	{ id: 3, name: "Sunglasses", price: "$42.00", image: "images/resource/products/3.jpg", categories: ["cat-1", "cat-2", "cat-4"] },
	{ id: 4, name: "Backpack", price: "$22.00", image: "images/resource/products/4.jpg", categories: ["cat-1", "cat-3"] },
	{ id: 5, name: "Hand Watch", price: "$34.00", image: "images/resource/products/5.jpg", categories: ["cat-1", "cat-3", "cat-5"] },
	{ id: 6, name: "Party Bag", price: "$25.00", image: "images/resource/products/6.jpg", categories: ["cat-2", "cat-3", "cat-4"] },
	{ id: 7, name: "Coffee Mug", price: "$20.00", image: "images/resource/products/7.jpg", categories: ["cat-1", "cat-2", "cat-5"] },
	{ id: 8, name: "Smart Watch", price: "$40.00", image: "images/resource/products/8.jpg", categories: ["cat-1", "cat-4", "cat-5"] },
];
	...
	return (
		...
		<div className="items-container row">
			{filteredProducts.map((product) => (
				<div key={product.id} className="product-block small-column product lenses mb-50 col-lg-3 col-md-6">
