                  ...
                  <table className="table table-striped table-bordered tbl-shopping-cart">
                    ...
                    <tbody>
                      ...
                      <tr className="cart_item">
                        ...
                        <td colSpan={2}>&nbsp;</td>
                        <td><button type="button" className="theme-btn btn-style-one" style={{ padding: "8px 21px" }}><span className="btn-title">Update Cart</span></button></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="row">
                  <div className="col-md-5">
                    ...
                    <form className="form" action="/">
                      ...
                      <div className="mb-30">
                        <button type="button" className="theme-btn btn-style-one" style={{ padding: "8px 21px" }}><span className="btn-title">Update Totals</span></button>
                      </div>
                    </form>
                  </div>
                  ...
                  <div className="col-md-5">
                    ...
                    <Link className="theme-btn btn-style-one" style={{ padding: "8px 21px" }} href="/shop-checkout"><span className="btn-title">Proceed to Checkout</span> </Link>
                  </div>
                </div>
              </div>
            </div>
